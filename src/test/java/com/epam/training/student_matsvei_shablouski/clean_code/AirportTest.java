...
public class AirportTest {
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        boolean hasOneBomber =  bomberMilitaryPlanes.stream().anyMatch(militaryPlane -> militaryPlane.getMilitaryType() == MilitaryType.BOMBER);
        Assert.assertTrue(hasOneBomber);
    }
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        ...
        for (ExperimentalPlane plane : experimentalPlanes) {
            Assert.assertNotEquals(plane.getClassificationLevel(), ClassificationLevel.UNCLASSIFIED);
        }
    }
