...
public class Main {
    public static void main(String[] args) {
        ...
        sortCars.listCarsOfThisBrand(Brand.AUDI).stream().forEach(car -> System.out.println(car.toString()));
        System.out.println();
        sortCars.listCarsOfThisBrandWhichUseMoreThanNnYears (Brand.BMW, 2).stream ().forEach (car -> System.out.println (car.toString ()));
        System.out.println();
        sortCars.listCarsOfThisYearsPriseMoreThanGiven(1998, 1700).stream().forEach(car -> System.out.println(car.toString()));
    }
}
